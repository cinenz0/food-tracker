...
const VERSION='food-tracker-v2-4';
const FILES=['/','/index.html','/app.css','/app.js','/sync-core.js','/model.js','/cloud.js','/photo.js','/config.js','/manifest.webmanifest','/icon-192.png','/icon-512.png','/iphone-qr.svg'];
